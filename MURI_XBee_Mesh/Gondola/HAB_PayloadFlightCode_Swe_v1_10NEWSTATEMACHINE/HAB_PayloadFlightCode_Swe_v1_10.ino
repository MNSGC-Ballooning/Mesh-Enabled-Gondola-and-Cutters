/**********************************************************************
   ...
   12/14/2020   PRW     SWE1.10 Added XBee_Mesh tab and functions to automize communication with cutter units
                                Modified exitsting communication and data entry functions to accomate mesh operations
...
/***********PERIODICALLY SAVE SD CARD***************/
      if ((millis() - timeSD) >= 1700) {            // Save once every 1.7 sec
